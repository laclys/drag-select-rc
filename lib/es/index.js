...
var DragSelect = function (props) {
    var _a = useState(false), selectionStarted = _a[0], setSelectionStarted = _a[1];
    var _b = useState(0), startRow = _b[0], setStartRow = _b[1];
    var _c = useState(0), startColumn = _c[0], setStartColumn = _c[1];
    var _d = useState(0), endRow = _d[0], setEndRow = _d[1];
    var _e = useState(0), endColumn = _e[0], setEndColumn = _e[1];
    var _f = useState(false), addMode = _f[0], setAddMode = _f[1];
    ...
    var renderRows = function () {
        return React.Children.map(props.children, function (tr, i) {
            return (React.createElement("tr", __assign({ key: i }, tr.props), React.Children.map(tr.props.children, function (cell, j) { return (React.createElement(Cell, __assign({ key: j + "_CELL", onTouchStart: handleTouchStartCell, onTouchMove: handleTouchMoveCell, selected: props.value[i][j] }, cell.props, { selecting: isCellBeingSelected(i, j) ? 1 : 0 }), cell.props.children)); })));
        });
    };
    return (React.createElement("table", { className: 'table-drag-select' },
...
var Cell = function (props) {
    ...
    return (React.createElement("td", __assign({ ref: tdRef, className: className, onMouseDown: handleTouchStart, onMouseMove: handleTouchMove }, props), props.children || React.createElement("span", null, "\u00A0")));
};
